...
public class GameActivity extends ActionBarActivity {
    ...
    private String player1;     // variable to store player1 name
    ...
    private static final String PBIRDS = "PBIRDS";
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        ...
        int[] pbirds = new int[2];
        pbirds[0] = P1Bird;
        pbirds[1] = P2Bird;
        bundle.putIntArray(PBIRDS, pbirds);
    ...
    protected void onRestoreInstanceState(Bundle bundle) {
        ...
        int[] pbirds = bundle.getIntArray(PBIRDS);
        P1Bird = pbirds[0];
        P2Bird = pbirds[1];
    ...
    public void onGameStateChange(View view){
        switch(gameView.getGameState()){
            ...
            case end:
                ...
                intent.putExtra("player1", player1);
                intent.putExtra("player2", player2);
                intent.putExtra("player1Count", Integer.toString(player1Count));
                intent.putExtra("player2Count", Integer.toString(player2Count));
